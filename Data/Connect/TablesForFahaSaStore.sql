...
CREATE TABLE Partners (
    id INT PRIMARY KEY IDENTITY(1,1),
	partner_type_id INT FOREIGN KEY REFERENCES PartnerTypes(id),
    name NVARCHAR(100) NOT NULL,
    address NVARCHAR(255) NOT NULL,
    phone NVARCHAR(20) NOT NULL,
    email NVARCHAR(100) NOT NULL,
...
CREATE TABLE Books (
    ...
    cover_type_id INT FOREIGN KEY REFERENCES CoverTypes(id),
    dimension_id INT FOREIGN KEY REFERENCES Dimensions(id),
    name NVARCHAR(255) NOT NULL,
...
CREATE TABLE BookPartners (
	...
	partner_id INT FOREIGN KEY REFERENCES Partners(id),
    note NVARCHAR(50),
...
CREATE TABLE FlashSaleBooks (
	id INT PRIMARY KEY IDENTITY(1,1),
    flash_sale_id INT FOREIGN KEY REFERENCES FlashSales(id),
    book_id INT FOREIGN KEY REFERENCES Books(id),
    discount_percentage INT NOT NULL CHECK (discount_percentage >= 0 AND discount_percentage <= 100),
	quantity INT NOT NULL CHECK (quantity >= 0),
...
CREATE TABLE Address (
    id INT PRIMARY KEY IDENTITY(1,1),
    user_id INT FOREIGN KEY REFERENCES AspNetUsers(id),
...
CREATE TABLE Orders (
	...
	payment_method_id INT FOREIGN KEY REFERENCES PaymentMethods(id),
...
CREATE TABLE Reviews (
	id INT PRIMARY KEY IDENTITY(1,1),
    book_id INT FOREIGN KEY REFERENCES Books(id),
    order_item_id INT UNIQUE FOREIGN KEY REFERENCES OrderItems(id),
    user_id INT FOREIGN KEY REFERENCES AspNetUsers(id),
    rating INT NOT NULL CHECK (rating >= 1 AND rating <= 5),
    comment NVARCHAR(250),
	active BIT NOT NULL,
	UNIQUE (book_id, order_item_id, user_id),
	created_at DATETIME DEFAULT GETDATE()
);
...
CREATE TABLE Carts (
    id INT PRIMARY KEY IDENTITY(1,1),
    user_id INT UNIQUE FOREIGN KEY REFERENCES AspNetUsers(id),
	created_at DATETIME DEFAULT GETDATE()
);
...
CREATE TABLE Notifications (
    id INT PRIMARY KEY IDENTITY(1,1),
	notification_type_id INT FOREIGN KEY REFERENCES NotificationTypes(id),
	user_id INT FOREIGN KEY REFERENCES AspNetUsers(id),
    title NVARCHAR(255) NOT NULL,
