...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => new { e.BookId, e.PartnerId }, "UQ__BookPart__2C7BEB52DC591EA5")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.UserId, "UQ__Carts__B9BE370EB4088C13")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => new { e.CartId, e.BookId }, "UQ__CartItem__2A65FB885850BCCA")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Name, "UQ__Categori__72E12F1B195C6390")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.TypeName, "UQ__CoverTyp__543C4FD975A6191D")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => new { e.Length, e.Width, e.Height, e.Unit }, "UQ__Dimensio__FCE485DDA9DA5845")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => new { e.UserId, e.BookId }, "UQ__Favourit__BD2EE6A09696DCBF")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => new { e.FlashSaleId, e.BookId }, "UQ__FlashSal__5124F239627BE999")
                    .IsUnique();
            ...
            modelBuilder.Entity<Menu>(entity =>
            {
                ...
                entity.HasIndex(e => e.Name, "UQ__Menu__72E12F1B6D8215E8")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Name, "UQ__Notifica__72E12F1B74DDF99D")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => new { e.OrderId, e.BookId }, "UQ__OrderIte__42C9B386F48865F1")
                    .IsUnique();
            ...
            modelBuilder.Entity<OrderStatus>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.OrderId, e.StatusId }, "UQ__OrderSta__4531597B6A659DFA")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Name, "UQ__PartnerT__72E12F1BDE8D36B6")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.OrderId, "UQ__Payments__465962289FF86255")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Name, "UQ__PaymentM__72E12F1B580B5E4D")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.PlatformName, "UQ__Platform__139DBE44187C7C74")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => new { e.BookId, e.OrderId, e.UserId }, "UQ__Reviews__C3D132F52926E23F")
                    .IsUnique();
            ...
            modelBuilder.Entity<Status>(entity =>
            {
                ...
                entity.HasIndex(e => e.Name, "UQ__Status__72E12F1BDDB21C09")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Name, "UQ__Subcateg__72E12F1BB3698F98")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.TopicName, "UQ__Topics__54BAE5ECCA1B091D")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Title, "UQ__TopicCon__E52A1BB305ED75F7")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Code, "UQ__Vouchers__357D4CF929AB74B4")
                    .IsUnique();
